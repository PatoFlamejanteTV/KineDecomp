...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void a(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (a2 != null && a2.getVisibility() != 8 && b(i2)) {
                LayoutParams layoutParams = (LayoutParams) a2.getLayoutParams();
                if (isLayoutRtl) {
                    left2 = a2.getRight() + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
                } else {
                    left2 = (a2.getLeft() - ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) - this.l;
                }
                b(canvas, left2);
            }
        }
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            int i3 = this.f2817c;
            if (this.f2818d == 1 && (i = this.f2819e & 112) != 48) {
                if (i == 16) {
                    i3 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f2820f) / 2;
                } else if (i == 80) {
                    i3 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f2820f;
                }
            }
    ...
    public void setVerticalGravity(int i) {
        ...
        int i3 = this.f2819e;
        if ((i3 & 112) != i2) {
            this.f2819e = i2 | (i3 & (-113));
            requestLayout();
        }
    }

    public void setWeightSum(float f2) {
        this.f2821g = Math.max(0.0f, f2);
    }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f2821g = obtainStyledAttributes.getFloat(R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f2816b = obtainStyledAttributes.getInt(R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.f2822h = obtainStyledAttributes.getBoolean(R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
