...
class j extends android.support.v4.widget.g implements View.OnClickListener {
    ...
    public j(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
    ...
    @Override // android.support.v4.widget.g, android.support.v4.widget.b
    public View a(Context context, Cursor cursor, ViewGroup viewGroup) {
        View a2 = super.a(context, cursor, viewGroup);
        a2.setTag(new a(a2));
        ((ImageView) a2.findViewById(a.e.edit_query)).setImageResource(this.o);
        return a2;
    }
    ...
    public static final class a {
        ...
        public a(View view) {
            this.f227a = (TextView) view.findViewById(R.id.text1);
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.b != null) {
            ...
            if (TextUtils.isEmpty(a2)) {
                if (aVar.f227a != null) {
                    aVar.f227a.setSingleLine(false);
                    aVar.f227a.setMaxLines(2);
                }
            } else if (aVar.f227a != null) {
                aVar.f227a.setSingleLine(true);
                aVar.f227a.setMaxLines(1);
            }
            a(aVar.b, a2);
        }
        if (aVar.c != null) {
        ...
        if (this.q == 2 || (this.q == 1 && (i & 1) != 0)) {
            ...
            aVar.e.setTag(aVar.f227a.getText());
    ...
    private CharSequence b(CharSequence charSequence) {
        if (this.r == null) {
            ...
            this.d.getTheme().resolveAttribute(a.C0016a.textColorSearchUrl, typedValue, true);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (a2 != null) {
                ((a) a2.getTag()).f227a.setText(e.toString());
            }
            return a2;
        }
    }
