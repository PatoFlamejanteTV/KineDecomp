...
public class h extends android.support.v7.internal.view.menu.c<android.support.v4.c.a.b> implements MenuItem {
    private Method c;
    ...
    public ActionProvider getActionProvider() {
        android.support.v4.g.a a2 = ((android.support.v4.c.a.b) this.b).a();
        if (a2 instanceof a) {
            return ((a) a2).f136a;
        }
        return null;
    ...
    public MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        ((android.support.v4.c.a.b) this.b).a(onActionExpandListener != null ? new c(onActionExpandListener) : null);
        return this;
    }
    ...
    private class d extends android.support.v7.internal.view.menu.d<MenuItem.OnMenuItemClickListener> implements MenuItem.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            return ((MenuItem.OnMenuItemClickListener) this.b).onMenuItemClick(h.this.a(menuItem));
        }
    }

    /* compiled from: MenuItemWrapperICS.java */
    /* loaded from: classes.dex */
    private class c extends android.support.v7.internal.view.menu.d<MenuItem.OnActionExpandListener> implements k.e {
        c(MenuItem.OnActionExpandListener onActionExpandListener) {
            super(onActionExpandListener);
        }

        @Override // android.support.v4.g.k.e
        public boolean a(MenuItem menuItem) {
            return ((MenuItem.OnActionExpandListener) this.b).onMenuItemActionExpand(h.this.a(menuItem));
        }

        @Override // android.support.v4.g.k.e
        public boolean b(MenuItem menuItem) {
            return ((MenuItem.OnActionExpandListener) this.b).onMenuItemActionCollapse(h.this.a(menuItem));
        }
    }
    ...
    /* compiled from: MenuItemWrapperICS.java */
    /* loaded from: classes.dex */
    public class a extends android.support.v4.g.a {

        /* renamed from: a, reason: collision with root package name */
        final ActionProvider f136a;

        public a(Context context, ActionProvider actionProvider) {
            super(context);
            this.f136a = actionProvider;
        }

        @Override // android.support.v4.g.a
        public View a() {
            return this.f136a.onCreateActionView();
        }

        @Override // android.support.v4.g.a
        public boolean d() {
            return this.f136a.onPerformDefaultAction();
        }

        @Override // android.support.v4.g.a
        public boolean e() {
            return this.f136a.hasSubMenu();
        }

        @Override // android.support.v4.g.a
        public void a(SubMenu subMenu) {
            this.f136a.onPrepareSubMenu(h.this.a(subMenu));
        }
    }

    /* compiled from: MenuItemWrapperICS.java */
    /* loaded from: classes.dex */
    static class b extends FrameLayout implements android.support.v7.e.a {

        /* renamed from: a, reason: collision with root package name */
        final CollapsibleActionView f137a;

        /* JADX WARN: Multi-variable type inference failed */
        b(View view) {
            super(view.getContext());
            this.f137a = (CollapsibleActionView) view;
            addView(view);
        }

        @Override // android.support.v7.e.a
        public void a() {
            this.f137a.onActionViewExpanded();
        }

        @Override // android.support.v7.e.a
        public void b() {
            this.f137a.onActionViewCollapsed();
        }

        View c() {
            return (View) this.f137a;
        }
    }
}
