...
public abstract class SharedElementCallback {
    ...
    /* renamed from: a */
    private static int f1048a = 1048576;

    /* renamed from: b */
    private Matrix f1049b;
    ...
    private static Bitmap a(Drawable drawable) {
        ...
        float min = Math.min(1.0f, f1048a / (intrinsicWidth * intrinsicHeight));
    ...
    public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
        ...
        float min = Math.min(1.0f, f1048a / (round * round2));
        int i = (int) (round * min);
        int i2 = (int) (round2 * min);
        if (this.f1049b == null) {
            this.f1049b = new Matrix();
        }
        this.f1049b.set(matrix);
        this.f1049b.postTranslate(-rectF.left, -rectF.top);
        this.f1049b.postScale(min, min);
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        canvas.concat(this.f1049b);
        view.draw(canvas);
        return createBitmap;
    }
