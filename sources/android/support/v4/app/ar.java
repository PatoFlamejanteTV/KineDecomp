...
public class ar {
    ...
    public static class a implements ah, ai {
        ...
        /* renamed from: a, reason: collision with root package name */
        private Notification.Builder f46a;
        ...
        public void a(an.a aVar) {
            this.c.add(ar.a(this.f46a, aVar));
        }
        ...
        public Notification b() {
            Notification build = this.f46a.build();
            ...
            a2.putAll(bundle);
            SparseArray<Bundle> a3 = ar.a(this.c);
            if (a3 != null) {
                ar.a(build).putSparseParcelableArray("android.support.actionExtras", a3);
            }
            return build;
        }
    }
    ...
    public static Bundle a(Notification.Builder builder, an.a aVar) {
        ...
        if (aVar.f() != null) {
            bundle.putParcelableArray("android.support.remoteInputs", ax.a(aVar.f()));
        }
        return bundle;
    }
}
