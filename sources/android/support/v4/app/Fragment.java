...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    View mView;
    String mWho;
    private static final android.support.v4.f.i<String, Class<?>> sClassMap = new android.support.v4.f.i<>();
    ...
    ay mEnterTransitionCallback = null;
    ay mExitTransitionCallback = null;
    ...
    public static class SavedState implements Parcelable {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            this.f27a = parcel.readBundle();
            if (classLoader != null && this.f27a != null) {
                this.f27a.setClassLoader(classLoader);
            }
        }
    ...
    public void setInitialSavedState(SavedState savedState) {
        ...
        this.mSavedFragmentState = (savedState == null || savedState.f27a == null) ? null : savedState.f27a;
    }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        android.support.v4.g.d.a(cloneInContext, this.mChildFragmentManager.v());
    ...
    public void setEnterSharedElementCallback(ay ayVar) {
        this.mEnterTransitionCallback = ayVar;
    }

    public void setExitSharedElementCallback(ay ayVar) {
        this.mExitTransitionCallback = ayVar;
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.a(this.mActivity, new j(this), this);
    }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        if (this.mChildFragmentManager != null && (j = this.mChildFragmentManager.j()) != null) {
