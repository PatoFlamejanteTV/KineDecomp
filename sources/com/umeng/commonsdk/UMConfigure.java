...
public class UMConfigure {
    ...
    private static void saveSDKComponent() {
        ...
        if (getClass("com.umeng.visual.UMVisualAgent") != null) {
            stringBuffer.append(FragmentC2201x.f23219a);
        }
        ...
        b.f26354a = stringBuffer.toString();
    ...
    private static void setLatencyWindow(long j) {
        com.umeng.commonsdk.statistics.a.f26352c = ((int) j) * 1000;
    }
    ...
    private static void setWraperType(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            if (str.equals("native")) {
                com.umeng.commonsdk.stateless.a.f26303a = "native";
                com.umeng.commonsdk.statistics.a.f26350a = "native";
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_X)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_COCOS2DX_X;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_COCOS2DX_X;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_XLUA)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_COCOS2DX_XLUA;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_COCOS2DX_XLUA;
            } else if (str.equals(WRAPER_TYPE_UNITY)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_UNITY;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_UNITY;
            } else if (str.equals(WRAPER_TYPE_REACTNATIVE)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_REACTNATIVE;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_REACTNATIVE;
            } else if (str.equals(WRAPER_TYPE_PHONEGAP)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_PHONEGAP;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_PHONEGAP;
            } else if (str.equals(WRAPER_TYPE_WEEX)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_WEEX;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_WEEX;
            } else if (str.equals(WRAPER_TYPE_HYBRID)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_HYBRID;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_HYBRID;
            } else if (str.equals(WRAPER_TYPE_FLUTTER)) {
                com.umeng.commonsdk.stateless.a.f26303a = WRAPER_TYPE_FLUTTER;
                com.umeng.commonsdk.statistics.a.f26350a = WRAPER_TYPE_FLUTTER;
            }
        }
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        com.umeng.commonsdk.stateless.a.f26304b = str2;
        com.umeng.commonsdk.statistics.a.f26351b = str2;
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    if (b.f26354a.indexOf("e") >= 0 && (cls = Class.forName("com.umeng.analytics.MobclickAgent")) != null && (declaredMethod5 = cls.getDeclaredMethod("disableExceptionCatch", new Class[0])) != null) {
                ...
                aVar.f26294a = applicationContext;
                aVar.f26295b = i;
                aVar.f26296c = str3;
                aVar.f26297d = str;
                aVar.f26298e = str2;
                aVar.f26299f = b.f26354a;
                aVar.f26300g = false;
                aVar.f26301h = UMFrUtils.getCurrentProcessName(applicationContext);
