...
public class Envelope {
    ...
    public void export(Context context) {
        ...
        String imprintProperty = UMEnvelopeBuild.imprintProperty(context, com.umeng.commonsdk.proguard.e.f26239f, null);
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject.put(com.umeng.commonsdk.proguard.e.f26239f, imprintProperty);
            }
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject2.put(com.umeng.commonsdk.proguard.e.f26239f, HelperUtils.getUmengMD5(imprintProperty));
            }
