...
public class SupportMapFragment extends Fragment {
    ...
    private final b f1926a = new b(this);
    ...
    public static class a implements MapLifecycleDelegate {
        ...
        public void a(Bundle bundle) {
            ...
            Bundle arguments = this.f1927a.getArguments();
        ...
        public void a(OnMapReadyCallback onMapReadyCallback) {
            try {
                this.b.a(new e(this, onMapReadyCallback));
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
            }
        }
    ...
    static class b extends com.google.android.gms.dynamic.zza<a> {
        ...
        public void i() {
            if (this.c == null || this.f1928a == null || a() != null) {
                return;
            }
            try {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View a2 = this.f1926a.a(layoutInflater, viewGroup, bundle);
    ...
    public void onInflate(Activity activity, AttributeSet attributeSet, Bundle bundle) {
        ...
        this.f1926a.a(activity, bundle2, bundle);
    }
