...
public interface zzjp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjp {
        ...
        /* loaded from: classes.dex */
        public static class a implements zzjp {

            /* renamed from: a */
            private IBinder f1732a;
            ...
            public void zza(GetRecentContextCall.Request request, zzjq zzjqVar) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(zzjqVar != null ? zzjqVar.asBinder() : null);
                    this.f1732a.transact(5, obtain, obtain2, 0);
            ...
            public void zza(zzjq zzjqVar) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                    obtain.writeStrongBinder(zzjqVar != null ? zzjqVar.asBinder() : null);
                    this.f1732a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zza(zzjq zzjqVar, String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    this.f1732a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zza(zzjq zzjqVar, String str, UsageInfo[] usageInfoArr) throws RemoteException {
                ...
                try {
                    ...
                    this.f1732a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zza(zzjq zzjqVar, boolean z) throws RemoteException {
                ...
                try {
                    ...
                    this.f1732a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzb(zzjq zzjqVar) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
                    obtain.writeStrongBinder(zzjqVar != null ? zzjqVar.asBinder() : null);
                    this.f1732a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzjp zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjp)) ? new a(iBinder) : (zzjp) queryLocalInterface;
        }
