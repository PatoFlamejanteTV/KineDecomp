...
public abstract class zzk<T> implements Comparable<zzk<T>> {
    ...
    public zzk(int i, String str, zzm.zza zzaVar) {
        this.zzD = zzs.a.f1832a ? new zzs.a() : null;
        this.zzK = true;
        this.zzL = false;
        this.zzM = false;
        this.zzN = 0L;
    ...
    public void zzc(String str) {
        if (zzs.a.f1832a) {
            this.zzD.a(str, Thread.currentThread().getId());
        } else if (this.zzN == 0) {
    ...
    public void zzd(String str) {
        ...
        if (Looper.myLooper() != Looper.getMainLooper()) {
            new Handler(Looper.getMainLooper()).post(new eu(this, str, id));
        } else {
            this.zzD.a(str, id);
            this.zzD.a(toString());
        }
