...
public abstract class zzbb implements Serializable, Iterable<Byte> {
    ...
    private static final InterfaceC1222s zzfj;
    private int zzfk = 0;

    static {
        zzfj = C1211m.a() ? new C1226u(null) : new r(null);
    }
    ...
    public static zzbb zzb(byte[] bArr, int i, int i2) {
        return new zzbi(zzfj.a(bArr, i, i2));
    }
    ...
    public static C1224t zzk(int i) {
        return new C1224t(i, null);
    }
