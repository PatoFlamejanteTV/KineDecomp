...
public final class Na {
    ...
    /* renamed from: a */
    private static final Oa f12803a;

    static {
        f12803a = La.b() && La.c() ? new Qa() : new Pa();
    }
    ...
    public static int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return f12803a.a(charSequence, bArr, i, i2);
    }
    ...
    public static boolean a(byte[] bArr) {
        return f12803a.a(bArr, 0, bArr.length);
    }

    public static boolean a(byte[] bArr, int i, int i2) {
        return f12803a.a(bArr, i, i2);
    }
