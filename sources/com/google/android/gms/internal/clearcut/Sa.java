...
interface Sa {
    ...
    void a(int i, zzbb zzbbVar) throws IOException;

    void a(int i, Object obj, InterfaceC1218pa interfaceC1218pa) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<zzbb> list) throws IOException;

    @Deprecated
    void a(int i, List<?> list, InterfaceC1218pa interfaceC1218pa) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, InterfaceC1218pa interfaceC1218pa) throws IOException;

    void b(int i, List<String> list) throws IOException;

    void b(int i, List<?> list, InterfaceC1218pa interfaceC1218pa) throws IOException;
