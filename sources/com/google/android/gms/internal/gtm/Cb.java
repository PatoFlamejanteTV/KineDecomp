...
public interface Cb {
    ...
    void a(int i, zzps zzpsVar) throws IOException;

    @Deprecated
    void a(int i, Object obj, _a _aVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<zzps> list) throws IOException;

    void a(int i, List<?> list, _a _aVar) throws IOException;
    ...
    void b(int i, Object obj, _a _aVar) throws IOException;

    void b(int i, List<String> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, _a _aVar) throws IOException;
