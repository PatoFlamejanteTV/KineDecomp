...
public final class zzbv extends zzan {
    ...
    public zzbv(zzap zzapVar) {
        super(zzapVar);
        this.zzyx = (AlarmManager) getContext().getSystemService(NotificationCompat.CATEGORY_ALARM);
    }
    ...
    public final void zzfd() {
        zzdb();
        Preconditions.b(this.zzyv, "Receiver not registered");
        long zzeq = zzbq.zzeq();
        if (zzeq > 0) {
            cancel();
            long c2 = zzcn().c() + zzeq;
            ...
            this.zzyx.setInexactRepeating(2, c2, zzeq, zzfe());
        }
    }
}
