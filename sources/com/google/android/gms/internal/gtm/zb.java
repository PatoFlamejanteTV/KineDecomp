...
final class zb extends yb {
                ...
                if (d2) {
                    ...
                    if (!e2) {
                        ...
                        if (f2) {
                            if (i6 < i3 - 1) {
                                int i8 = i6 + 1;
                                xb.b(b3, bArr[i6], bArr[i8], cArr, i5);
                                i = i8 + 1;
                                i5++;
                            } else {
                                throw zzrk.zzpw();
                            ...
                            byte b5 = bArr[i6];
                            int i10 = i9 + 1;
                            xb.b(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                            i = i10 + 1;
                            i5 = i5 + 1 + 1;
                        } else {
                            throw zzrk.zzpw();
    ...
    */
    public final int a(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.gtm.zb.a(java.lang.CharSequence, byte[], int, int):int");
    }

    @Override // com.google.android.gms.internal.gtm.yb
    public final void a(CharSequence charSequence, ByteBuffer byteBuffer) {
        yb.b(charSequence, byteBuffer);
    }
}
