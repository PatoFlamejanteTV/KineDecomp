...
final class Ab {
    ...
    public static void b(byte b2, byte b3, char[] cArr, int i) throws zzuv {
        if (b2 >= -62 && !g(b3)) {
    ...
    public static void b(byte b2, byte b3, byte b4, char[] cArr, int i) throws zzuv {
    ...
    public static void b(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i) throws zzuv {
