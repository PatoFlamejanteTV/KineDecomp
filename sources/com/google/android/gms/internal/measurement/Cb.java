...
final class Cb extends Bb {
                ...
                if (d2) {
                    ...
                    if (!e2) {
                        ...
                        if (f2) {
                            if (i6 < i3 - 1) {
                                int i8 = i6 + 1;
                                Ab.b(b3, bArr[i6], bArr[i8], cArr, i5);
                                i = i8 + 1;
                                i5++;
                            } else {
                                throw zzuv.zzwx();
                            ...
                            byte b5 = bArr[i6];
                            int i10 = i9 + 1;
                            Ab.b(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                            i = i10 + 1;
                            i5 = i5 + 1 + 1;
                        } else {
                            throw zzuv.zzwx();
    ...
    */
    public final int a(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.Cb.a(java.lang.CharSequence, byte[], int, int):int");
    }
