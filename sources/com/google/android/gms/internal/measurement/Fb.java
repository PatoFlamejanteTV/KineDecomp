...
public interface Fb {
    ...
    void a(int i, zzte zzteVar) throws IOException;

    void a(int i, Object obj, InterfaceC1353cb interfaceC1353cb) throws IOException;
    ...
    @Deprecated
    void a(int i, List<?> list, InterfaceC1353cb interfaceC1353cb) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, InterfaceC1353cb interfaceC1353cb) throws IOException;

    void b(int i, List<String> list) throws IOException;

    void b(int i, List<?> list, InterfaceC1353cb interfaceC1353cb) throws IOException;
