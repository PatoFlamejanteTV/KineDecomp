...
public final class zzya {
    ...
    public final void zze(int i, zzvv zzvvVar) throws IOException {
        zztv zzyz = zzyz();
        zzyz.zza(i, zzvvVar);
        zzyz.flush();
        this.zzces = this.zzbur.position();
    ...
    public final void zzb(int i, String str) throws IOException {
        ...
        try {
            ...
            zzyb zzybVar = new zzyb(this.zzbur.position(), this.zzbur.limit());
            zzybVar.initCause(e2);
            throw zzybVar;
        }
    }
    ...
    public final void zza(int i, zzyi zzyiVar) throws IOException {
        zzc(i, 2);
        zzb(zzyiVar);
    }
    ...
    public final void zzb(zzyi zzyiVar) throws IOException {
        zzcd(zzyiVar.zzzh());
        zzyiVar.zza(this);
    }

    public static int zzb(int i, zzyi zzyiVar) {
        int zzbd = zzbd(i);
        int zzvx = zzyiVar.zzvx();
