...
public interface zzft extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzft {
        ...
        /* loaded from: classes.dex */
        private static class a implements zzft {

            /* renamed from: a, reason: collision with root package name */
            private IBinder f1717a;
            ...
            public void onActivityResult(int i, int i2, Intent intent) throws RemoteException {
                ...
                try {
                    ...
                    this.f1717a.transact(3, obtain, obtain2, 0);
            ...
            public void onCreate() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseManager");
                    this.f1717a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseManager");
                    this.f1717a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static zzft zzQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzft)) ? new a(iBinder) : (zzft) queryLocalInterface;
        }
