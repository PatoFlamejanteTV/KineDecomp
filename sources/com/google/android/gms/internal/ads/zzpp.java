...
public final class zzpp {
    ...
    private static final int[] zzbhj = {96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, io.fabric.sdk.android.a.b.c.MAX_BYTE_SIZE_PER_FILE, 7350};
    private static final int[] zzbhk = {0, 1, 2, 3, 4, 5, 6, 8, -1, -1, -1, 7, 8, -1, 8, -1};

    private static int zza(zzpw zzpwVar) {
        int zzbj = zzpwVar.zzbj(5);
        return zzbj == 31 ? zzpwVar.zzbj(6) + 32 : zzbj;
    }

    private static int zzb(zzpw zzpwVar) {
        int zzbj = zzpwVar.zzbj(4);
        if (zzbj == 15) {
            return zzpwVar.zzbj(24);
        }
