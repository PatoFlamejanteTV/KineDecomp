...
public interface zzia {
    ...
    int zzv(int i) throws IOException, InterruptedException;

    void zzw(int i) throws IOException, InterruptedException;

    void zzx(int i) throws IOException, InterruptedException;
}
