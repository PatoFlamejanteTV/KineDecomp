...
public class zzayv extends zzayx {
    ...
    public final String getDefaultUserAgent(Context context) {
        ...
        if (TextUtils.isEmpty(zzaal.zzeiz)) {
            if (ClientLibraryUtils.a()) {
                str = (String) zzbak.zza(context, new Yd(zzaal, context));
            } else {
                str = (String) zzbak.zza(context, new Zd(zzaal, GooglePlayServicesUtilLight.getRemoteContext(context), context));
            }
            zzaal.zzeiz = str;
        }
        return zzaal.zzeiz;
    ...
    @Override // com.google.android.gms.internal.ads.zzayx, com.google.android.gms.internal.ads.zzays, com.google.android.gms.internal.ads.zzayp
    ...
    public final void zzaz(Context context) {
        ...
        if (!defaultUserAgent.equals(zzaal.zzeiz)) {
            ...
            if (ClientLibraryUtils.a() || remoteContext == null) {
