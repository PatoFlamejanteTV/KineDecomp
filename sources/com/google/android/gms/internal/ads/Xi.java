...
public interface Xi {
    ...
    void a(int i, zzbpu zzbpuVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    @Deprecated
    void a(int i, Object obj, InterfaceC1112ui interfaceC1112ui) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<zzbpu> list) throws IOException;

    void a(int i, List<?> list, InterfaceC1112ui interfaceC1112ui) throws IOException;
    ...
    void b(int i, Object obj, InterfaceC1112ui interfaceC1112ui) throws IOException;

    void b(int i, List<String> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, InterfaceC1112ui interfaceC1112ui) throws IOException;
