...
public interface zzcj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcj {
        ...
        /* loaded from: classes.dex */
        private static class a implements zzcj {

            /* renamed from: a, reason: collision with root package name */
            private IBinder f1688a;
            ...
            public String getContent() throws RemoteException {
                ...
                try {
                    ...
                    this.f1688a.transact(2, obtain, obtain2, 0);
            ...
            public void recordImpression() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
                    this.f1688a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zza(com.google.android.gms.dynamic.zzd zzdVar) throws RemoteException {
                ...
                try {
                    ...
                    this.f1688a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public String zzdr() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
                    this.f1688a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readString();
                } finally {
                    obtain2.recycle();
        ...
        public static zzcj zzr(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzcj)) ? new a(iBinder) : (zzcj) queryLocalInterface;
        }
