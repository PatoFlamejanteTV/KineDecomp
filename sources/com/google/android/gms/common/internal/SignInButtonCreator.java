...
public final class SignInButtonCreator extends RemoteCreator<ISignInButtonCreator> {
    ...
    /* renamed from: a */
    private static final SignInButtonCreator f11134a = new SignInButtonCreator();
    ...
    private final View b(Context context, int i, int i2) throws RemoteCreator.RemoteCreatorException {
        try {
            ...
            return (View) ObjectWrapper.a(getRemoteCreatorInstance(context).a(ObjectWrapper.a(context), signInButtonConfig));
        } catch (Exception e2) {
