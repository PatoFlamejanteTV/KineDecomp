...
public final class ConnectionErrorMessages {
    ...
    /* renamed from: a */
    private static final SimpleArrayMap<String, String> f11081a = new SimpleArrayMap<>();
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return DeviceProperties.d(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, a2);
        }
        if (i == 3) {
    ...
    public static String d(Context context, int i) {
        String e2;
        if (i == 6) {
            e2 = a(context, "common_google_play_services_resolution_required_title");
        } else {
            e2 = e(context, i);
        }
        return e2 == null ? context.getResources().getString(R.string.common_google_play_services_notification_ticker) : e2;
    }
