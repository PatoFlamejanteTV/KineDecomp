...
public class GooglePlayServicesUtilLight {
    ...
    public static void ensurePlayServicesAvailable(Context context, int i) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int a2 = GoogleApiAvailabilityLight.a().a(context, i);
        if (a2 != 0) {
            Intent a3 = GoogleApiAvailabilityLight.a().a(context, a2, "e");
    ...
    public static boolean honorsDebugCertificates(Context context) {
        try {
            if (!zzak) {
                ...
                if (b2 != null && !GoogleSignatureVerifier.a(b2, false) && GoogleSignatureVerifier.a(b2, true)) {
                    zzaj = true;
                } else {
                    zzaj = false;
                }
        ...
        return zzaj || !DeviceProperties.a();
    }
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return PlatformVersion.e() && (applicationRestrictions = ((UserManager) context.getSystemService("user")).getApplicationRestrictions(context.getPackageName())) != null && ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(applicationRestrictions.getString("restricted_profile"));
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        return zza(context, (DeviceProperties.d(context) || DeviceProperties.e(context)) ? false : true, i);
    }
}
