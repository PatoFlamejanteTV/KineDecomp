...
public class TreeMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
    ...
    private transient Comparator<? super K> f2781a;
    ...
    public /* bridge */ /* synthetic */ SortedSet get(Object obj) {
        return super.get((TreeMultimap<K, V>) obj);
    }
    ...
    @Override // com.google.common.collect.AbstractSortedSetMultimap, com.google.common.collect.AbstractMultimap, com.google.common.collect.Multimap
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        this.f2781a = (Comparator) Preconditions.a((Comparator) objectInputStream.readObject());
        this.b = (Comparator) Preconditions.a((Comparator) objectInputStream.readObject());
        setMap(new TreeMap(this.f2781a));
