...
/* synthetic */ class X {
    ...
    static final /* synthetic */ int[] f14575a = new int[GeneratedMessageLite.MethodToInvoke.values().length];

    static {
        try {
            f14575a[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
