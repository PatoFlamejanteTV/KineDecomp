...
public final class ScreencastDispatcher {
    ...
    public class BitmapFetchRunnable implements Runnable {
        ...
        public void run() {
            updateScreenBitmap();
            Handler handler = ScreencastDispatcher.this.mBackgroundHandler;
            EventDispatchRunnable eventDispatchRunnable = ScreencastDispatcher.this.mEventDispatchRunnable;
            EventDispatchRunnable.access$400(eventDispatchRunnable, this);
    ...
    private class EventDispatchRunnable implements Runnable {
        ...
        static /* synthetic */ EventDispatchRunnable access$400(EventDispatchRunnable eventDispatchRunnable, Runnable runnable) {
            eventDispatchRunnable.withEndAction(runnable);
