...
public class TestUserManager {
    ...
    private AccessToken getAccessTokenForUser(List<String> list, Mode mode, String str) {
        ...
        return new AccessToken(findOrCreateSharedTestAccount.optString("access_token"), this.testApplicationId, findOrCreateSharedTestAccount.optString(ShareConstants.WEB_DIALOG_PARAM_ID), asList, null, AccessTokenSource.TEST_USER, null, null);
    }
