...
public final class FacebookRequestError implements Parcelable {
    ...
    static final a HTTP_RANGE_SUCCESS = new a(200, 299, null);
    public static final Parcelable.Creator<FacebookRequestError> CREATOR = new l();
    ...
    public static class a {
        ...
        /* synthetic */ a(int i, int i2, l lVar) {
            this(i, i2);
        }

        boolean a(int i) {
            return this.f9132a <= i && i <= this.f9133b;
        }
    ...
    public /* synthetic */ FacebookRequestError(Parcel parcel, l lVar) {
        this(parcel);
    }
        ...
        try {
            if (jSONObject.has("code")) {
                ...
                if (!HTTP_RANGE_SUCCESS.a(i2)) {
                    return new FacebookRequestError(i2, -1, -1, null, null, null, null, false, jSONObject.has(BODY_KEY) ? (JSONObject) Utility.getStringPropertyAsJSON(jSONObject, BODY_KEY, GraphResponse.NON_JSON_RESPONSE_PROPERTY) : null, jSONObject, obj, httpURLConnection, null);
                }
            }
