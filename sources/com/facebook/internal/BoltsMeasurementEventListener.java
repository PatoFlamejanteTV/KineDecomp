...
public class BoltsMeasurementEventListener extends BroadcastReceiver {
    ...
    private void open() {
        android.support.v4.a.f.a(this.applicationContext).a(this, new IntentFilter(MEASUREMENT_EVENT_NOTIFICATION_NAME));
    }

    private void close() {
        android.support.v4.a.f.a(this.applicationContext).a(this);
    }
