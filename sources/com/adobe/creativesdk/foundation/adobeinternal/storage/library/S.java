...
public class S implements qb {
    ...
    final /* synthetic */ C0231f f4547b;

    /* renamed from: c, reason: collision with root package name */
    final /* synthetic */ String f4548c;

    /* renamed from: d, reason: collision with root package name */
    final /* synthetic */ ha f4549d;

    /* JADX INFO: Access modifiers changed from: package-private */
    public S(ha haVar, int i, C0231f c0231f, String str) {
        this.f4549d = haVar;
        this.f4546a = i;
        this.f4547b = c0231f;
        this.f4548c = str;
    ...
    public void a(C0233g c0233g) {
        ...
        try {
            this.f4549d.a(this.f4547b, this.f4548c, c0233g, (AdobeCSDKException) null);
    ...
    public void a(C0233g c0233g, AdobeCSDKException adobeCSDKException) {
        ...
        try {
            this.f4549d.a(this.f4547b, this.f4548c, c0233g, adobeCSDKException);
        } catch (AdobeCSDKException e2) {
            com.adobe.creativesdk.foundation.internal.utils.logging.c.a(Level.ERROR, Gb.class.getSimpleName(), "", e2);
        }
    }
