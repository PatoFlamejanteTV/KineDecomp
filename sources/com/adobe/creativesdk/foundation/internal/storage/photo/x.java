...
public class x implements ra.b {
    ...
    final /* synthetic */ AdobePhotoAsset f6758a;

    /* renamed from: b, reason: collision with root package name */
    final /* synthetic */ c.a.a.a.b f6759b;

    /* renamed from: c, reason: collision with root package name */
    final /* synthetic */ c.a.a.a.c f6760c;

    /* renamed from: d, reason: collision with root package name */
    final /* synthetic */ F f6761d;

    /* JADX INFO: Access modifiers changed from: package-private */
    public x(F f2, AdobePhotoAsset adobePhotoAsset, c.a.a.a.b bVar, c.a.a.a.c cVar) {
        this.f6761d = f2;
        this.f6758a = adobePhotoAsset;
        this.f6759b = bVar;
        this.f6760c = cVar;
    }
    ...
    public void a(com.adobe.creativesdk.foundation.internal.net.l lVar) {
        ...
        if (lVar.g() != 201) {
            a2 = this.f6761d.a(lVar);
        } else {
            com.adobe.creativesdk.foundation.internal.utils.logging.c.a(Level.INFO, "PhotoSession:uploadRendition", String.format("Rendition data for asset %s uploaded", this.f6758a.getName()));
            a2 = null;
        }
        if (a2 == null) {
    ...
    public void a(AdobeNetworkException adobeNetworkException) {
        ...
        a2 = this.f6761d.a(adobeNetworkException);
        if (a2 != null) {
            a3 = this.f6761d.a(a2);
            adobePhotoException = a3;
        ...
        this.f6760c.a(adobePhotoException);
    }
}
