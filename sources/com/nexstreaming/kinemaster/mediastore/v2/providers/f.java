...
public class f implements Comparator<MediaStoreItem> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public f(AndroidMediaStoreProvider androidMediaStoreProvider, int i) {
    ...
    public int compare(MediaStoreItem mediaStoreItem, MediaStoreItem mediaStoreItem2) {
        return this.f3580a * mediaStoreItem.f().compareTo(mediaStoreItem2.f());
    }
}
