...
public class TransparentTextView extends TextView {
    ...
    private void a() {
        this.f4383a = getResources().getDrawable(R.drawable.trans_tv_bg);
        setLayerType(1, null);
        this.c = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.f4383a.setBounds(0, 0, getWidth(), getHeight());
        this.f4383a.setState(getDrawableState());
        this.f4383a.draw(canvas);
        if (isPressed()) {
