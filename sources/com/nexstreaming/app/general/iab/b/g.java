...
class g implements ResultTask.OnResultAvailableListener<CpOrderListResponse> {
    ...
    final /* synthetic */ IABHelper.c f3163a;
    final /* synthetic */ a b;
            ...
            switch (ResponseCode.fromValue(cpOrderListResponse.getResult())) {
                case SUCCESS:
                    ...
                    if (a2 != null && a2.size() > 0) {
                        ...
                        if (z) {
                            o4 = this.b.o();
                            if (((List) o4.get(IABHelper.SKUType.wechat)).size() > 0) {
                                o5 = this.b.o();
                                Purchase purchase2 = (Purchase) ((List) o5.get(IABHelper.SKUType.wechat)).get(0);
                                if (purchase.c() != null && purchase2.c() != null && purchase.c().getTime() >= purchase2.c().getTime()) {
                                    o6 = this.b.o();
                                    o6.put(IABHelper.SKUType.wechat, a2);
                                    this.b.r = false;
                                }
                            }
                        }
                        o3 = this.b.o();
                        o3.put(IABHelper.SKUType.wechat, a2);
                        this.b.r = false;
                    }
                    ...
                    IABHelper.c cVar = this.f3163a;
                    o2 = this.b.o();
                    cVar.a(o2);
                    return;
                case NOT_FOUND_LIST:
                    this.f3163a.b(IABError.PurchasedNotFound, "error loading purchase list code " + cpOrderListResponse.getResult());
                    return;
                default:
                    ...
                    this.f3163a.b(IABError.NetworkError, "error loading purchase list code " + cpOrderListResponse.getResult());
                    return;
            }
        }
    }
