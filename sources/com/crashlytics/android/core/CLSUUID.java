...
class CLSUUID {
    ...
    public CLSUUID(IdManager idManager) {
        ...
        populatePID(bArr);
        String c2 = CommonUtils.c(idManager.f());
        String a2 = CommonUtils.a(bArr);
        _clsId = String.format(Locale.US, "%s-%s-%s-%s", a2.substring(0, 12), a2.substring(12, 16), a2.subSequence(16, 20), c2.substring(0, 12)).toUpperCase(Locale.US);
    }
