...
public class LicenseChecker {
    ...
    public LicenseChecker(Activity activity, String str, String str2, String str3, LicenseCheckerCallback licenseCheckerCallback) {
        ...
        this.mAppId = str;
        this.purchaseWindow = new c(this, null);
    }

    public static /* synthetic */ ILicenseService access$102(LicenseChecker licenseChecker, ILicenseService iLicenseService) {
        licenseChecker.mService = iLicenseService;
        return iLicenseService;
    }

    public static /* synthetic */ g access$200(LicenseChecker licenseChecker) {
        return licenseChecker.mValidatorHandler;
    }

    public static /* synthetic */ boolean access$302(LicenseChecker licenseChecker, boolean z) {
        licenseChecker.mChecking = z;
        return z;
    }
