...
class q extends Thread {
    ...
    final /* synthetic */ MiResponseListener f4904a;
    ...
    public q(MiCommplatform miCommplatform, MiResponseListener miResponseListener, String str) {
        ...
        this.f4904a = miResponseListener;
        this.b = str;
    }
    ...
    public void run() {
        ...
        try {
            ...
            if (check_and_connect != 0) {
                this.c.mTouch = false;
                this.f4904a.sendResultCode(-107, null);
            } else {
                iGameCenterSDK = this.c.sdk;
                MiGamMessageResponse subscribeVip = iGameCenterSDK.subscribeVip(this.b);
                if (subscribeVip == null) {
                    ...
                    this.f4904a.sendResultCode(subscribeVip.getSdkStatus(), subscribeVip.getMsgResult());
                    this.c.mTouch = false;
