...
class v extends Thread {
    ...
    public void run() {
        ...
        try {
            try {
                check_and_connect = this.c.check_and_connect(this.f4911a, false);
                ...
                if (vipList != null) {
                    this.c.mTouch = false;
                    check_user_changed = this.c.check_user_changed(this.f4911a, vipList.getSdkStatus());
                    if (!check_user_changed) {
                        this.b.sendResultMsg(vipList.getSdkStatus(), vipList.getMsgResult());
                    }
                } else {
                    this.b.sendResultMsg(-107, null);
                }
