...
public class dc extends AsyncTask<Void, Void, Bitmap> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public dc(NexVideoClipItem nexVideoClipItem, File file, int i, ResultTask resultTask) {
    ...
    public Bitmap doInBackground(Void... voidArr) {
        ...
        boolean z;
        boolean z2;
        Bitmap a2 = NexImageLoader.loadBitmap(this.f4592a.getAbsolutePath(), (this.b * 16) / 9, this.b).a();
        if (a2 != null) {
            i = this.d.m_rotation;
            z = this.d.m_fliph;
            z2 = this.d.m_flipv;
